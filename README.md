...
| Observational (k=2, IV) | suicidality (composite) | 0.94 (0.82–1.09) | 23% | Low |
| Observational (k=4, IV) | suicide attempt/self-harm | 0.71 (0.58–0.87) | 10% | Low |
...
briefs/    Stream A synthesis brief + anchor reproduction brief (markdown)
```
